...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorMessage === "Credenciais incorretas" && isLogin) {
        setError("Email/telefone ou senha incorretos. Não tem conta? Clique em 'Cadastre-se' abaixo.")
      } else {
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-3xl font-bold text-green-600">EcoEnergy</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Recuperar Senha</h1>
            <p className="text-gray-600">
              {forgotPasswordSuccess
                ? "Link enviado com sucesso!"
                : "Insira seu email ou telefone para receber o link de recuperação"}
            </p>
          </div>
            ...
            {forgotPasswordSuccess ? (
              <div className="space-y-6">
                <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg text-sm text-center">
                  Enviamos um link de recuperação para {emailOrPhone}. Verifique sua caixa de entrada ou mensagens.
                </div>
                <button
                  onClick={() => {
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            © 2025 EETEPA Oriximiná - Projeto de Conscientização Energética
          </p>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isLogin ? "Entre para acessar seu painel de energia" : "Comece a monitorar seu consumo de energia"}
          </p>
        </div>
